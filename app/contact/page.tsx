...
export default function ContactPage() {
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 xl:gap-20 items-start pb-20 xl:pb-28">
                    ...
                    <div>
                        <motion.span
                            ...
                            className="text-[8px] xl:text-[9px] 2xl:text-[11px] 3xl:text-[13px] uppercase tracking-[0.5em] text-white/30 font-bold mb-7 block"
                        >
                            The Commitment
                        </motion.span>
                        ...
                        <motion.h1
                            ...
                            className="text-[3.5rem] sm:text-[5rem] md:text-[6.5rem] xl:text-[7.5rem] 2xl:text-[9rem] 3xl:text-[10rem]
                        ...
                        <motion.p
                            ...
                            className="text-[10px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[15px] uppercase tracking-[0.2em] text-white/35 leading-relaxed
                            ...
                            {contactInfo.map((info, i) => (
                                ...
                                >
                                   ...
                                   group-hover:before:h-full before:transition-all before:duration-500 before:ease-out" />
                                    ...
                                    <p className="text-[7px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[16px] uppercase tracking-[0.45em] text-white/25 font-bold mb-2.5">
                                        {info.label}
                                    </p>
                                    {/* ✅ FIX: use <a> so email is a real link, no translateX overflow bug */}
                                    <a
                                        href={`mailto:${info.value}`}
                                        className="text-sm xl:text-base 2xl:text-lg 3xl:text-[24px] font-black tracking-tight text-white/60
                                ...
                                <AnimatePresence mode="wait">
                                    {status === "success" ? (
                                      ...
                                      justify-center mb-6">
                                            ...
                                            <h2 className="text-xl xl:text-2xl 2xl:text-3xl 3xl:text-4xl font-black uppercase italic tracking-tighter mb-3">
                                                Transmission Received.
                                            </h2>
                                            <p className="text-[8px] xl:text-[9px] 2xl:text-[11px] 3xl:text-[13px] uppercase tracking-[0.4em] text-white/30">
                                        ...
                                        >
                                            ...
                                            <div>
                                                <div className="flex justify-between items-center mb-2.5">
                                                    <label htmlFor="contact-name" className="text-[7px] xl:text-[8px] 2xl:text-[13px] 3xl:text-[20px] uppercase tracking-[0.45em] text-white font-bold">
                                                        The Name
                                                    </label>
                                                    {errors.name && (
                                                        <span className="text-[7px] xl:text-[8px] 2xl:text-[13px] 3xl:text-[20px] uppercase tracking-widest text-red-500 font-bold">
                                                            {errors.name}
                                                        </span>
                                                    )}
                                                </div>
                                        ...
                                        after:transition-all after:duration-500">
                                                    <input
                                                        ...
                                                        className={`w-full bg-transparent py-4 text-white text-[10px] xl:text-[11px] 2xl:text-[12px] 3xl:text-[15px] font-bold
                                       ...
                                       ${errors.name ? "border-red-500/40" : "border-white/8 focus:border-white/15"}`}
                                            ...
                                            <div>
                                                <div className="flex justify-between items-center mb-2.5">
                                                    <label htmlFor="contact-email" className="text-[7px] xl:text-[8px] 2xl:text-[13px] 3xl:text-[12px] uppercase tracking-[0.45em] text-white font-bold">
                                                        The Email
                                                    </label>
                                                    {errors.email && (
                                                        <span className="text-[7px] xl:text-[8px] 2xl:text-[13px] 3xl:text-[12px] uppercase tracking-widest text-red-500 font-bold">
                                                            {errors.email}
                                                        </span>
                                                    )}
                                                </div>
                                        ...
                                        after:transition-all after:duration-500">
                                                    <input
                                                        ...
                                                        className={`w-full bg-transparent py-4 text-white text-[10px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[15px] font-bold
                                       ...
                                       ${errors.email ? "border-red-500/40" : "border-white/8 focus:border-white/15"}`}
                                            ...
                                            <div>
                                                <div className="flex justify-between items-center mb-2.5">
                                                    <label htmlFor="contact-phone" className="text-[7px] xl:text-[8px] 2xl:text-[13px] 3xl:text-[20px] uppercase tracking-[0.45em] text-white font-bold">
                                                        Contact Number
                                                    </label>
                                                </div>
    ...
    after:transition-all after:duration-500">
      ...
      transition-colors duration-300 border-white/8 focus:border-white/15"
                                            ...
                                            <div>
                                                <label className="text-[7px] xl:text-[8px] 2xl:text-[13px] 3xl:text-[20px] uppercase tracking-[0.45em] text-white font-bold mb-3 block">
                                                    Business Stage
                                                </label>
                                                <div className="flex flex-wrap gap-2">
                                                    {STAGES.map(s => (
                                                        <button
                                                            ...
                                                            type="button"
                                                            onClick={() => setStage(s)}
                                                            className={`px-4 py-2 rounded-full border text-[7px] xl:text-[8px] 2xl:text-[13px] 3xl:text-[20px] font-bold
                                         ...
                                         ${stage === s
                                            ...
                                            <div>
                                                <div className="flex justify-between items-center mb-2.5">
                                                    <label htmlFor="contact-message" className="text-[7px] xl:text-[8px] 2xl:text-[13px] 3xl:text-[20px] uppercase tracking-[0.45em] text-white font-bold">
                                                        Main Challenge
                                                    </label>
                                                    {errors.message && (
                                                        <span className="text-[7px] xl:text-[8px] 2xl:text-[13px] 3xl:text-[20px] uppercase tracking-widest text-red-500 font-bold">
                                        ...
                                        after:transition-all after:duration-500">
                                                    <textarea
                                                        ...
                                                        className={`w-full bg-transparent py-4 text-white text-[10px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[20px] font-bold
                                       ...
                                       ${errors.message ? "border-red-500/40" : "border-white/8 focus:border-white/15"}`}
                                            ...
                                            <button
                                                ...
                                                className="w-full bg-white text-black rounded-full py-4 xl:py-5 text-[9px] xl:text-[10px] 2xl:text-[13px] 3xl:text-[20px]
            ...
            <div className="border-y border-white/5 py-12">
                <div className="mx-auto px-10">
                    <p className="text-[9px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] uppercase tracking-[0.4em] text-gray-500 font-bold text-center">
            ...
            <section className="bg-white text-black py-28 md:py-40 xl:py-52 text-center relative overflow-hidden px-6">
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-[2.5rem] sm:text-[4rem] md:text-[5.5rem] xl:text-[7rem] 2xl:text-[8.5rem] 3xl:text-[9.5rem]
            ...
            rounded-full text-[9px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] font-black uppercase tracking-[0.45em]

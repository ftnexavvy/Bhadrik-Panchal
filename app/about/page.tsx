...
export default function AboutPage() {
  ...
  ">
        ...
        ">
              ...
              [&:nth-child(n+3)]:border-t [&:nth-child(n+3)]:border-white/[0.07] md:[&:nth-child(n+3)]:border-t-0
              [&:nth-child(even)]:border-l [&:nth-child(even)]:border-white/[0.07]
              md:[&:not(:first-child)]:border-l md:[&:not(:first-child)]:border-white/[0.07]
            ...
            <section className="xl:py-15 2xl:py-32 bg-white text-black relative overflow-hidden">
                <div className="max-w-[1200px] mx-auto px-6 grid md:grid-cols-3 gap-12 relative z-10">
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
                            <Magnet strength={0.2}>
                                <Link
                                    href="/contact"
                                    className="px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 xl:px-6 xl:py-3 2xl:px-8 2xl:py-4 4xl:px-12 4xl:py-6 bg-black text-white text-[9px] sm:text-[10px] md:text-[12px] xl:text-[8px] 2xl:text-[10px] 4xl:text-[14px] font-black tracking-widest uppercase italic hover:bg-gray-900 transition-all duration-300 rounded-full inline-block flex items-center justify-center active:scale-95 shadow-xl"
                                >
                                    Book a Clarity Call
                                </Link>
                            </Magnet>
